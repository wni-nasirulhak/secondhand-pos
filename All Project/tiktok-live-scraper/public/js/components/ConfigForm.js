        ...
        this.container.innerHTML = `
            <div class="config-form">
                ...
                <div class="form-group">
                    ...
                    <small>ใส่ URL ของ TikTok Live ที่ต้องการดึงคอมเมนต์</small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="mode-toggle-wrapper" style="display: flex; gap: 10px; margin-top: 5px;">
                        <label class="mode-option" style="flex: 1; cursor: pointer;">
                            ...
                            <div class="mode-card" style="padding: 10px; border: 2px solid var(--border-color); border-radius: 8px; text-align: center; transition: all 0.3s;">
                                📖 อ่านอย่างเดียว
                            </div>
                        </label>
                        <label class="mode-option" style="flex: 1; cursor: pointer;">
