...
export class ConfigForm {
        ...
        this.accordion.addSection('การตั้งค่าพื้นฐาน', (contentDiv) => {
            contentDiv.innerHTML = `
                <div class="form-group">
                    ...
                    <small style="color: var(--text-secondary);">ใส่ URL ของ TikTok Live ที่ต้องการดึงคอมเมนต์</small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="mode-toggle-wrapper" style="display: flex; gap: 10px; margin-top: 5px;">
                        <label class="mode-option" style="flex: 1; cursor: pointer;">
                            <input type="radio" name="work-mode" value="read" checked style="display: none;">
                            <div class="mode-card" style="padding: 12px; border: 2px solid var(--border-color); border-radius: 8px; text-align: center; transition: all 0.3s;">
                                📖 อ่านอย่างเดียว
                            </div>
                        </label>
                        <label class="mode-option" style="flex: 1; cursor: pointer;">
    ...
    validate() {
        ...
        if (!config.url || !config.url.includes('tiktok.com')) {
            errors.push('กรุณาใส่ TikTok URL ที่ถูกต้อง');
        }
