  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-4 md:space-y-8 pb-20 px-3 md:px-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-4 md:gap-6 items-start">
                    ...
                    <td className="px-4 md:px-8 py-4 md:py-6 text-right">
                      <div className="flex items-center justify-end gap-1.5 md:gap-2 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
                        <button 
                          ...
                          className="p-2 md:p-2 bg-indigo-50 text-indigo-600 rounded-lg hover:bg-indigo-100 transition-all"
                        >
        ...
        {selectedCustomer && (
          <div className="fixed inset-0 z-[120] bg-slate-900/50 backdrop-blur-sm xl:hidden" onClick={() => setSelectedCustomer(null)} />
        )}
        <div className={`
          ${selectedCustomer ? 'fixed inset-x-0 bottom-0 top-0 z-[130] overflow-y-auto bg-white' : 'hidden'}
          xl:relative xl:block xl:col-span-4 xl:sticky xl:top-4 xl:bg-transparent xl:z-auto xl:inset-auto xl:overflow-visible
        `}>
          {selectedCustomer ? (
            <div className="bg-white xl:rounded-[40px] xl:border xl:border-slate-100 xl:shadow-xl overflow-hidden animate-in slide-in-from-right-4 min-h-full xl:min-h-0">
