...
export const Alert = ({ variant = 'info', title, children, onClose, icon, className = '' }: AlertProps) => {
  const variantStyles = {
    ...
    >
      <div className="flex items-start">
        ...
        {onClose && (
          <button
            onClick={onClose}
            className="flex-shrink-0 ml-3 inline-flex text-gray-400 hover:text-gray-600 transition-colors"
